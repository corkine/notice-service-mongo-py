...
class ZMZChecker:
    ...
    def checkData(self,meta={}):
        ...
        return wlist,p2list,1 if isend != 0 else 0
...
if __name__ == "__main__":  
    ...
    checker = ZMZChecker(autocheck=True,metadata=METADATA,slackurl="https://hooks.slack.com/services/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")  