    ...
    def checkData(self,meta={}):
        ...
        if len(pitems) > 2:
            ...
            pitems.append(meta["info"].split(" ")[0]+" "+"有多条推送，请访问网页查看。"
                +" "+meta["info"].split(" ")[2])
        return ritems,pitems,1 if isend != 0 else 0
...
if __name__ == "__main__":  
    ...
    checker = BiliChecker(autocheck=True,metadata=METADATA,slackurl="https://hooks.slack.com/services/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")  