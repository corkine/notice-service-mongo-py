...
#             "func": lambda meta:getattr(bilibiliChecker.BiliChecker(metadata=meta),"checkData")()},
#         "zimuzu":{
#             "type":"zimuzu",
#             "slack_url":"https://hooks.slack.com/services/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",
#             "func": lambda meta:getattr(zimuzuChecker.ZMZChecker(metadata=meta),"checkData")()},
#         "express":{
#             "type":"express",
#             "slack_url":"https://hooks.slack.com/services/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",
#             "func": lambda meta:getattr(expressChecker.ExpressChecker(metadata=meta),"checkData")()},
#         "test":{
#             "type":"test",
#             "slack_url":"https://hooks.slack.com/services/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"},
#         },
